  ...
  static final List<Location> items = [ //beginning of array
    Location(
        ...
        facts: <LocationFact>[
          ...
          LocationFact(title: 'Sports Teams', text: 'Has a great soccer team and marvellous netball team'),
          LocationFact(title: 'Classes', text: 'S1 to S6 - 2 streams each  atleast 90 students '),
          ...
          LocationFact(title: 'Uniform Colors', text: 'Cream_white and Maroon and Veil fors girls ')
    ...
    Location(
        ...
        facts: <LocationFact>[
          ...
          LocationFact(title: 'Sports Teams', text: 'Has the best soccer team_district champions 2019'),
          LocationFact(title: 'Classes', text: 'S1 to S6 - 4 streams each  atleast 80 students '),
          LocationFact(title: 'School Type', text: 'Private School '),
          LocationFact(title: 'Status of school', text: 'Day and Boarding '),
          LocationFact(title: 'Levels', text: ' Both Sciences and Arts, best at A_level sciences in district '),
          LocationFact(title: 'Uniform Colors', text: 'Light blue_Dark blue for O_level and Light blue_Maron for A_level ')
        ]), //second
    Location(
        name: 'StJohns_ss',
        url:
        ...
        facts: <LocationFact>[
          ...
          LocationFact(title: 'Sports Teams', text: 'Has a giant soccer team and powerful volley ball team'),
          LocationFact(title: 'Classes', text: 'S1 to S6 - 2 streams each  atleast 102 students '),
          LocationFact(title: 'School Type', text: 'Private School '),
          LocationFact(title: 'Status of school', text: 'Day and with  good Hostels for girls '),
          LocationFact(title: 'Levels', text: ' Both Sciences and Arts '),
          LocationFact(title: 'Uniform Colors', text: 'Light blue_Gray for O_level and Zebra stripped_Gray for A_level  ')
        ]),
    Location(
        ...
        facts: <LocationFact>[
          ...
          LocationFact(title: 'Sports Teams', text: 'Has great volley ball and hockey teams'),
          LocationFact(title: 'Classes', text: 'S1 to S4 - 1 stream each  atleast 40 students '),
          LocationFact(title: 'School Type', text: 'Private School '),
          LocationFact(title: 'Status of school', text: 'Day school '),
          LocationFact(title: 'Levels', text: ' Both Sciences and Arts for O_level '),
    ...
    Location(
        ...
        facts: <LocationFact>[
          ...
          LocationFact(title: 'How to get there', text: 'Along Jinja road_kisenyi'),
          LocationFact(title: 'Sports Teams', text: 'Has a thunderous soccer team and a powerful debating club'),
          LocationFact(title: 'Classes', text: 'S1 to S6 - 5 streams each  atleast 95 students '),
          LocationFact(title: 'School Type', text: 'Government School '),
          LocationFact(title: 'Status of school', text: 'Day school '),
          LocationFact(title: 'Levels', text: ' Both Sciences and Arts '),
          LocationFact(title: 'Uniform Colors', text: 'White_Black for O_level and Light blue_Gray for A'
              '-level ')
